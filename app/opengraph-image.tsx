...
export default function OpenGraphImage() {
  ...
  return new ImageResponse(
    <div style={{ position: "relative", width: "100%", height: "100%", display: "flex", overflow: "hidden", background: "#050A0F", color: "#F3EEE5" }}>
      ...
      <div style={{ position: "relative", width: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "68px 72px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          <span style={{ display: "flex", width: 76, height: 2, marginBottom: 24, background: "#D8B46F" }} />
          <span style={{ display: "flex", fontSize: 46, lineHeight: 1.35, whiteSpace: "nowrap" }}>記念日に、フレンチを。</span>
        </div>
      </div>
    </div>,
  );
